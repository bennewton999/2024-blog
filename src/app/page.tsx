...
const AsteroidsGame = lazy(() =>
  import('@/components/asteroids-game').then(module => ({
    default: module.AsteroidsGame
  }))
);
...
export default function Home() {
  ...
  const resetGame = () => {
    ...
    document
      .querySelectorAll('[style*="opacity: 0"], [style*="scale(0)"]')
      .forEach(element => {
    ...
    <div className="container py-6 lg:py-10">
      ...
      <section className="mx-auto w-full max-w-6xl pb-16">
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-background via-background to-muted/20 p-8 lg:p-12 shadow-2xl shadow-black/10 backdrop-blur-sm dark:shadow-black/30 group">
          ...
          <div
            className={`relative flex flex-col items-center justify-between gap-10 pb-6 text-center transition-opacity duration-500 ${
          ...
          >
            ...
            <div className="flex items-center gap-4 w-full max-w-lg">
              ...
              <div
                className="w-3 h-3 rounded-full bg-gradient-to-r from-primary to-accent animate-spin"
