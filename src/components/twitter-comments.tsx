  ...
  return (
    <div className="border-t border-border mt-8 pt-6">
      ...
      <div className="flex flex-col space-y-4">
        <p>Join the discussion about this post on 𝕏:</p>
        <a
          href={twitterThreadUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-primary text-primary-foreground hover:bg-primary/90 w-fit"
        >
