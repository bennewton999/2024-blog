...
date: '2025-07-27'
description: 'How a vacation without my laptop led me to build VoiceCommit - an AI-powered voice-first tool that turns spoken commerce and development ideas into GitHub Issues, PRs, and updates.'
author: 'ben-newton'
...
- **[Command-Driven Development Logging with Claude Code](/blog/command-driven-development-logging-claude)** - My system for documenting development progress with visual screenshots and structured session tracking
- **[Claude Code Is More Than a Dev Assistant—It's My Project Manager](/blog/claude-code-roadmap-management)** - How I use Claude Code with ROADMAP.md for systematic project management
- **[Raycast: A Productivity Tool for Developers](/blog/raycast)** - Another essential productivity tool that's transformed my daily workflow
