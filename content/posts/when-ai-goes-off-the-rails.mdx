...
<blockquote class="twitter-tweet" data-theme="dark">
  <p lang="en" dir="ltr">
    agreed - this is really where we are going with the whole &#39;prompt
    files&#39; and instructions effort. let folks document core workflows on
    your team, and then you can scale that knowledge out to the whole group.
    <br />
    <br />i also commonly use the URL fetching we shipped in 1.99 to supplement…
  </p>
  &mdash; Pierce Boggan (@pierceboggan){' '}
  <a href="https://twitter.com/pierceboggan/status/1922064227403235698?ref_src=twsrc%5Etfw">
    May 12, 2025
  </a>
</blockquote> <script
  async
